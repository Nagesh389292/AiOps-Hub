...
class MistralRunner(BaseModelRunner):
    """Runner for Mistral AI models via their native API."""

    MISTRAL_BASE_URL = "https://api.mistral.ai/v1"

    def __init__(self, runtime_mode: str = "mock", model_name: str = "mistral-small-latest") -> None:
    ...
    def generate(self, prompt: str, category: str = "coding") -> ModelOutput:
        ...
        try:
            ...
            client = OpenAI(api_key=api_key, base_url=self.MISTRAL_BASE_URL)

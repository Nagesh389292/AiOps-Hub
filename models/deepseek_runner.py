...
class DeepSeekRunner(BaseModelRunner):
    """Runner for DeepSeek models via their OpenAI-compatible API."""

    BASE_URL = "https://api.deepseek.com"

    def __init__(self, runtime_mode: str = "mock", model_name: str = "deepseek-chat") -> None:
